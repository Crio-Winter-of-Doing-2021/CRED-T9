            ...
            <div>
                ...
                <form className="form">
                    ...
                    <div className="form-group">
                        ...
                        <span className="error-message">{this.state.errors[CARD_NUMBER]}</span>
                    </div>
                    <div className="form-group">
                        <label>CVV</label>
                        <input
                    ...
                    <div className="form-group">
                        ...
                        <span className="error-message">{this.state.errors[EXPIRY]}</span>
                    </div>
                    <div className="form-group">
                        <label>Name</label>
                        <input
                    ...
                    {this.props.addCardState.error ? <span className="row d-flex justify-content-center error-message">{this.props.addCardState.error}</span> : ""}
                </form>
            </div>
        )
    }
